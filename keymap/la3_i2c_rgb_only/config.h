...
#define DEVICE_NAME_0                   "P42 BLE 1"                         /**< Name of device. Will be included in the advertising data. */
#define DEVICE_NAME_1                   "P42 BLE 2"                         /**< Name of device. Will be included in the advertising data. */
#define DEVICE_NAME_2                   "P42 BLE 3"     
...
// 列 接到 74HC595 的哪个 Qx
#define COL_TO_74HC595_PINS  {_1_595_Q1, _1_595_Q2, _1_595_Q3, _1_595_Q4, _1_595_Q5, \
    _1_595_Q6,_1_595_Q7,_1_595_Q0, _2_595_Q1,_2_595_Q2,_2_595_Q5}
// 定义列映射到 74HC595 的管脚数量
#define COL_TO_74HC595_PINS_COUNT   11
// 第几个列开始接到595
#define COL_TO_74HC595_START_INDEX  0
// 到第几个列结束到595
#define COL_TO_74HC595_END_INDEX    10
#define I_595_NUM   2       // 用了多少个595
/* Pin connected to DS of 74HC595 */
#define DS_PIN_74HC595      9
/* Pin connected to SH_CP of 74HC595 SCK 对应移位时钟*/
#define SHCP_PIN_74HC595    17
/* Pin connected to ST_CP of 74HC595 RCK 锁存时钟*/
#define STCP_PIN_74HC595    20
...
#define CX_WK 28 // 用来中断,接受拉高唤醒
#define SPLIT_KEYBOARD

#define TWI_SCL_M           10       //!< Master SCL pin.
#define TWI_SDA_M           2      //!< Master SDA pin.

#define I2C_SLAVE_ADDRESS 0x20  // 这是从机地址
#define I2C_SLAVE_ADDR_2 0x21  // 第二个从机
#define I2C_SPLIT_QF_ENABLED
// #define UART_SPLIT_QF_ENABLED
#ifdef UART_SPLIT_QF_ENABLED
#define RX_QF 2 // UART_RX口IO
#define TX_QF 10 // UART_TX口IO
#endif
