...
#define DEVICE_NAME_0                   "P42 BLE1"                         /**< Name of device. Will be included in the advertising data. */
#define DEVICE_NAME_1                   "P42 BLE2"                         /**< Name of device. Will be included in the advertising data. */
#define DEVICE_NAME_2                   "P42 BLE3"     
