...
#define MATRIX_ROW_PINS { 2, 29, 31, 30}
//C0 to C4 thsi si 840 version , pls note 1.13/1.05  NA/1.11 025/1.10
#define MATRIX_COL_PINS { 10, 42, 3, 28,45, \
                          1,24,13,5,41,   \
                          9 }    
...
#define STATE_LED_01 NRF_GPIO_PIN_MAP(0, 6)
#define STATE_LED_02 NRF_GPIO_PIN_MAP(0, 8)
#define STATE_LED_03 NRF_GPIO_PIN_MAP(0, 4)
#define STATE_RADIO_04 NRF_GPIO_PIN_MAP(0, 26)
...
#define RGB_MAX_SLEEP_SEC 1800
#define BLE_SYSTEM_OFF_SEC 1802


#define BLE_BLINK_LED_ENABLE
#define SLEEP_COUNTER_MAX 6
