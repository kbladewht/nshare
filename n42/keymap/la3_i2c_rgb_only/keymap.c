...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = {
        ...
        { KC_PSLS, KC_PAST,KC_PPLS, KC_PMNS ,   KC_F1, KC_F2,KC_F3, KC_F4},
        { KC_P7,   KC_P8,  KC_P9,   KC_P0,      KC_F5, KC_F6,KC_F7, KC_F8},
        { KC_P4,   KC_P5,  KC_P6,   KC_KP_DOT,  KC_F9, KC_F10,KC_F11, KC_F12},
        { KC_P1,   KC_P2,  KC_P3,   KC_KP_ENTER,KC_INS, KC_DEL,KC_PGUP, KC_PGDN}
    }   
	, [1] = {
